...
class UploaderButton extends Element {
	...
	public function getAssets() {
		return array('js' => array('mapbender.element.uploaderbutton.js', '@SpookyIslandUploadBundle/Resources/public/js/jquery.form.js'), 'css' => array('mapbender.element.uploaderbutton.css'));
	}
	...
	public static function getDefaultConfiguration() {
		return array("tooltip" => "uploader button");
	}
	...
	public function render() {
		...
		return $this -> container -> get('templating') -> render('SpookyIslandUploadBundle:Element:uploaderbutton.html.twig', array('id' => $this -> getId(), 'title' => $this -> getTitle(), 'configuration' => $this -> getConfiguration(), 'appname' => $this -> application -> getSlug(), 'form' => $form -> createView()));
	}
